...
?>
			...
			if(($entry->status != 0) && ($entry->status != -1)){			
			    $bare_url=admin_url('admin.php?page=newsletter-manager-manage-emails&action=email_unsubscribe&id='.$entry->id.'&search='.$email);;
			?>
			<a
			...
			<?php 
			    ...
			    $bare_url=admin_url('admin.php?page=newsletter-manager-manage-emails&action=email_activate&id='.$entry->id.'&search='.$email);
			?>
			<a
			...
			?>
			<?php $bare_url=admin_url('admin.php?page=newsletter-manager-manage-emails&action=email_delete&id='.$entry->id.'&search='.$email);
			?>
			</td>
			<td id="tdCenter" ><a
